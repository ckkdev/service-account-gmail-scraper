    ...
    for email_user in email_users:
        ...
        for label in labels:
            ...
            for ref in message_refs:
                ...
                parts = evaluateMessagePayload(payload, email_user, ref['id'], attachments, service)
                for part in parts:
                ...
                if html_msg is not None:
                    ...
                    print('this is not html nor plain/text, attachments handled seperately')
...
#handling attachments - payload
def evaluateMessagePayload(payload: dict, user_id: str, msg_id: str, attachments: str, service: object)->List[dict]:
    ...
    if 'attachmentId' in payload['body']:  # if it's an attachment
        ...
        if 'parts' in payload:
            for part in payload['parts']:
                ret.extend(evaluateMessagePayload(part, user_id, msg_id, attachments, service))
        return ret
